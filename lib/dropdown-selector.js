    ...
    _createClass(DropdownSelector, [{
        ...
        value: function mounted() {
            if (this.appendToBody) {
                ...
                this.scrollParent = (0, _getScrollParent2.default)(this.$refs.popupContainer);
        ...
        value: function getPopupPosition() {
            ...
            var offsetLeft = triggerBounding.left + this.scrollParent.scrollX;
            var offsetTop = triggerBounding.bottom + this.scrollParent.scrollY;
            return {
                left: offsetLeft + "px",
                top: offsetTop + "px",
        ...
        key: "popupStyle",
        get: function get() {
            return Object.assign({ width: this.dropdownWidth ? this.dropdownWidth + "px" : null }, this.popupPosition);
        }
    }]);
