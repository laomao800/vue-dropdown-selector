    ...
    _createClass(DropdownSelector, [{
            ...
            if (this.appendToBody) {
                ...
                this.$nextTick().then(function () {
                    var loopGetScrollParent = function loopGetScrollParent(parentEle) {
                        ...
                        _this3.scrollParents.push(parent);
                    };
                    loopGetScrollParent((0, _getScrollParent2.default)(_this3.$refs.popupTrigger));
                    _this3.scrollParents.forEach(function (element) {
                        element.addEventListener('scroll', _this3.updatePopupPosition);
                    });
                });
            }
        }
        ...
        value: function beforeDestroy() {
            ...
            this.scrollParents.forEach(function (element) {
                element.removeEventListener('scroll', _this4.updatePopupPosition);
            });
            if (this.appendToBody) {
