/*! @laomao800/vue-dropdown-selector v1.0.1 */
...
function parseSizeWithUnit(value) {
  var isPercent = /\d+%/.test(value);
  var num = parseInt(value, 10);
  return num ? isPercent ? "".concat(num, "%") : "".concat(num, "px") : null;
}
